...
Agent generated with [`googleCloudPlatform/agent-starter-pack`](https://github.com/GoogleCloudPlatform/agent-starter-pack) version `0.21.1`
...
```
adk-test-python/
├── my_agent/                 # Core application code
...
2. **Integrate:** Import your agent into the app by editing `my_agent/agent.py`.
